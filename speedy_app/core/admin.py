...
class CertificateAdmin(admin.ModelAdmin):
	...
	fieldsets = (
		('Basic Information', {
			'fields': ('title', 'description', 'certificate_type', 'is_active', 'url')
		}),
		('Display Settings', {
		...
		('Icon / Image', {
			...
			'description': 'Upload an image (preferred) or enter the SVG path element (the "d" attribute value). If both are provided, the image will be used.'
		}),
	)
