...
class Certificate(models.Model):
    ...
    image = models.ImageField(upload_to='certificates/', blank=True, null=True, help_text="Upload an image to use instead of SVG icon.")
    icon_color = models.CharField(max_length=7, default='#4abbc1', help_text="Hex color code for icon background")
    url = models.URLField(blank=True, null=True, help_text="Optional: Link to open when certificate is clicked.")
