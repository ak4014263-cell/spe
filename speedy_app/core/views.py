...
def contact_form_view(request):
    ...
    # On GET, render the contact form template
    if request.method == "GET":
        return render(request, "speedy_app/contact_form.html")
        ...
        if order_json:
            try:
                ...
                if booking:
                    ...
                    from speedy_app.core.models import Payment
                    if not Payment.objects.filter(reservation=booking.reservation).exists():
